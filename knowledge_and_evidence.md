  ...
  ***
  ...
  1. **Defined Colors and Their Location:**
     ...
     2. What type of variables hold these colors? Are the values expected to change during the program's execution? Explain your answer.
        > They are considered to be class variables. Unless different colours are being accessed/called then the colour will remain unchanged, being yellow. The type of variables holding these colours are considered to be tuples, this also means that the data within it is immutable and does not have the ability to have their values changed within it. 
        > 
  ...
  > In reference to the my_complexion method specifically, the OOP that best applies to it would be abstraction. As the method heading is just a name/reference which hides its complexities ie it exposes what it does without exposing how it does it.
  ...
  <img width="458" height="338" alt="image" src="https://github.com/user-attachments/assets/976352f0-5376-4dfd-aa06-a9294913f67d" />
